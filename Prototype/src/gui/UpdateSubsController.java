...
public class UpdateSubsController 
{
    ...
    @FXML
    private ChoiceBox<?> customerType;

    @FXML
    private Spinner<?> numberChains;

    @FXML
    private Label customerId;

    @FXML
    private CheckBox updatesOk;

    @FXML
    private CheckBox checkComp1;

    @FXML
    private CheckBox checkComp2;

    @FXML
    private CheckBox checkComp3;

    @FXML
    private CheckBox checkComp4;

    @FXML
    private CheckBox checkComp5;
